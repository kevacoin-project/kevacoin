...
UniValue validateaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"VTRMKQcFgd4LQyoBT28GNBrt9f6AaEUVJn\"")
            + HelpExampleRpc("validateaddress", "\"VTRMKQcFgd4LQyoBT28GNBrt9f6AaEUVJn\"")
        );
...
UniValue verifymessage(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"VTRMKQcFgd4LQyoBT28GNBrt9f6AaEUVJn\", \"signature\", \"my message\"")
        );
